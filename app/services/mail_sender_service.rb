...
class MailSenderService
  ...
  def send_signup_instructions
    ...
    message_html = [
      ...
      "#{@sender.full_name} has invited you to join TheLife Mobile App! TheLife App is a smart evangelism toolbox with the goal of helping you connect your friends to Jesus in meaningful ways. It'll help you evaluate what their current needs are in their journey, and suggest ways to help them take the next step towards knowing God.<br />",
      ...
      "#{@sender.full_name} vous a invit&eacute; &agrave; vous joindre au test b&ecirc;ta de LaVie Mobile. LaVie Mobile est un atelier intelligent pour l'&eacute;vang&eacute;lisation, qui a comme but de vous aider &agrave; connecter vos amis avec J&eacute;sus de fa&ccedil;on significative. Il vous aidera &agrave; &eacute;valuer o&ugrave; vos amis sont dans leur cheminement, et sugg&eacute;rera des actions concr&egrave;tes pour les aider &agrave; prendre le prochain pas vers Dieu.<br />",
    ...
    @message_hash = {
      subject: 'LaVie Mobile / TheLife Mobile App',
      html: message_html,
      to:[
