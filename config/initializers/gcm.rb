configatron do |c|
  ...
  c.gcm_on_rails.api_url = 'https://android.googleapis.com/gcm/send'
  ...
  c.gcm_on_rails.api_key = ENV['GOOGLE_API_KEY']

  # It is an application package name
  c.gcm_on_rails.app_name = 'com.yourapp.package.name'
  ...
  c.gcm_on_rails.delivery_format = 'json'
end
